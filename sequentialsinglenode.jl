...
usable_DR_fraction = params.dravailable #Participation factor eps [0,1]

#Initialize timesteps and MC iterations
MonteCarloIterations = params.nsamples
...
solar_cap_factor = sum(solar_power,1)./timesteps./solar_maxima
wind_cap_factor = sum(wind_power,1)./timesteps./wind_maxima
